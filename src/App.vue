...
export default {
  ...
  watch: {
    nightMode(newVal) {
      document.body.classList.toggle("bg-dark", newVal);
      document.body.classList.toggle("bg-light", !newVal);
      document.body.classList.toggle("text-light", newVal);
      document.body.classList.toggle("text-dark", !newVal);
    },
  },
  created() {
